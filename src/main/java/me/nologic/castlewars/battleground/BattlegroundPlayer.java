...
public class BattlegroundPlayer implements MinorityFeature {
    ...
    @ConfigurationKey(name = "label", value = "#dbb623🏹 #c97a1e&lCastle Wars #dbb623🏹")
    ...
    public void showSidebar() {
        this.sidebar = ProtocolSidebar.newBungeeChatSidebar(TextComponent.fromLegacyText(sidebarLabel), CastleWars.getPlugin(CastleWars.class));
    ...
    public static BattlegroundPlayer getBattlegroundPlayer(Player player) {
        return CastleWars.getPlugin(CastleWars.class).getGameMaster().getPlayerManager().getBattlegroundPlayer(player);
    }
    ...
    public void disconnect() {
        CastleWars.getInstance().getGameMaster().getPlayerManager().disconnect(this);
    }
